...
BEGIN
  ...
  WITH s AS (INSERT INTO public.sequences (id,owner_id,title,type,template_group,is_template,is_published,completion_action,reward_text)
    VALUES('00000000-0000-0000-0000-000000000004',NULL,
  ...
  -- 5. Get Dressed
  WITH s AS (INSERT INTO public.sequences (id,owner_id,title,type,template_group,is_template,is_published,completion_action,reward_text)
    VALUES('00000000-0000-0000-0000-000000000005',NULL,
  ...
  -- 6. Make Breakfast
  WITH s AS (INSERT INTO public.sequences (id,owner_id,title,type,template_group,is_template,is_published,completion_action,reward_text)
    VALUES('00000000-0000-0000-0000-000000000006',NULL,
  ...
  -- 7. Eat Breakfast
  WITH s AS (INSERT INTO public.sequences (id,owner_id,title,type,template_group,is_template,is_published,completion_action,reward_text)
    VALUES('00000000-0000-0000-0000-000000000007',NULL,
  ...
  WITH s AS (INSERT INTO public.sequences (id,owner_id,title,type,template_group,is_template,is_published,completion_action,reward_text)
    VALUES('00000000-0000-0000-0000-000000000008',NULL,
  ...
  -- 12. Get on the Bus
  WITH s AS (INSERT INTO public.sequences (id,owner_id,title,type,template_group,is_template,is_published,completion_action,reward_text)
    VALUES('00000000-0000-0000-0000-000000000012',NULL,
  ...
  WITH s AS (INSERT INTO public.sequences (id,owner_id,title,type,template_group,is_template,is_published,completion_action,reward_text)
    VALUES('00000000-0000-0000-0000-000000000014',NULL,
  ...
  -- 15. Get Off the Bus
  WITH s AS (INSERT INTO public.sequences (id,owner_id,title,type,template_group,is_template,is_published,completion_action,reward_text)
    VALUES('00000000-0000-0000-0000-000000000015',NULL,
  ...
  WITH s AS (INSERT INTO public.sequences (id,owner_id,title,type,template_group,is_template,is_published,completion_action,reward_text)
    VALUES('00000000-0000-0000-0000-000000000016',NULL,
  ...
  -- 17. School Goodbye
  WITH s AS (INSERT INTO public.sequences (id,owner_id,title,type,template_group,is_template,is_published,completion_action,reward_text)
    VALUES('00000000-0000-0000-0000-000000000017',NULL,
  ...
  -- 18. School Pick Up
  WITH s AS (INSERT INTO public.sequences (id,owner_id,title,type,template_group,is_template,is_published,completion_action,reward_text)
    VALUES('00000000-0000-0000-0000-000000000018',NULL,
  ...
  -- 19. Coming Home
  WITH s AS (INSERT INTO public.sequences (id,owner_id,title,type,template_group,is_template,is_published,completion_action,reward_text)
    VALUES('00000000-0000-0000-0000-000000000019',NULL,
  ...
  -- 20. Calm Down
  WITH s AS (INSERT INTO public.sequences (id,owner_id,title,type,template_group,is_template,is_published,completion_action,reward_text)
    VALUES('00000000-0000-0000-0000-000000000020',NULL,
  ...
  -- 21. Homework Time
  WITH s AS (INSERT INTO public.sequences (id,owner_id,title,type,template_group,is_template,is_published,completion_action,reward_text)
    VALUES('00000000-0000-0000-0000-000000000021',NULL,
  ...
  -- 22. Play Time
  WITH s AS (INSERT INTO public.sequences (id,owner_id,title,type,template_group,is_template,is_published,completion_action,reward_text)
    VALUES('00000000-0000-0000-0000-000000000022',NULL,
  ...
  -- 23. TV & iPad Time
  WITH s AS (INSERT INTO public.sequences (id,owner_id,title,type,template_group,is_template,is_published,completion_action,reward_text)
    VALUES('00000000-0000-0000-0000-000000000023',NULL,
  ...
  -- 24. Dinner Time
  WITH s AS (INSERT INTO public.sequences (id,owner_id,title,type,template_group,is_template,is_published,completion_action,reward_text)
    VALUES('00000000-0000-0000-0000-000000000024',NULL,
  ...
  WITH s AS (INSERT INTO public.sequences (id,owner_id,title,type,template_group,is_template,is_published,completion_action,reward_text)
    VALUES('00000000-0000-0000-0000-000000000025',NULL,
  ...
  -- 26. Bath Time
  WITH s AS (INSERT INTO public.sequences (id,owner_id,title,type,template_group,is_template,is_published,completion_action,reward_text)
    VALUES('00000000-0000-0000-0000-000000000026',NULL,
  ...
  WITH s AS (INSERT INTO public.sequences (id,owner_id,title,type,template_group,is_template,is_published,completion_action,reward_text)
    VALUES('00000000-0000-0000-0000-000000000027',NULL,
  ...
  -- 28. Bedtime Routine
  WITH s AS (INSERT INTO public.sequences (id,owner_id,title,type,template_group,is_template,is_published,completion_action,reward_text)
    VALUES('00000000-0000-0000-0000-000000000028',NULL,
